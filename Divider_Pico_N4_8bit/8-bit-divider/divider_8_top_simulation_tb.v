	...
	begin : Trace
		...
		forever
			begin
				...
				$fdisplay(instruction_trace_file, "Addr: %h  Instr: %h %s Dividend_s0: %h Divisor_s1: %h Quotient_s2: %h Remainder_s0: %h Control_s4: %h  cc: %0d ", ADDR, INSTR, INSTR_ASCII, uut.processor.bank_a_s0, uut.processor.bank_a_s1, uut.processor.bank_a_s2, uut.processor.bank_a_s0, uut.processor.bank_a_s4,  clk_cnt);
				ADDR = address;
				@(negedge ClkPort);
			end
