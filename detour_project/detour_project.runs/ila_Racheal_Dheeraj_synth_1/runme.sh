...
HD_PWD='C:/Users/rache_000/Desktop/detour_project/detour_project.runs/ila_Racheal_Dheeraj_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_Racheal_Dheeraj.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_Racheal_Dheeraj.tcl
